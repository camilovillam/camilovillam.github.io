...
*This post is also available in video format [here](https://youtu.be/pYsobwkkROM){:target="_blank"}*

---
*If you want to keep exploring and see dbt in action in a simple data transformation project, check out this blog and its accompanying video: [An Introduction to dbt](https://camilovilla.net/blog/an-introduction-to-dbt){:target="_blank"}*
